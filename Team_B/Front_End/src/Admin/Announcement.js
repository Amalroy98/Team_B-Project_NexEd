...
const Communication = () => {
  ...
  const Save = (e) => {
    ...
    axios
      .post("http://localhost:5066/api/Announcement/AddNotification/",notification)
      .then((response) => {
...
//   const Search = () => {
//     axios
//       .get("http://localhost:5066/api/Announcement/GetNotification/" + id)
//       .then((response) => {
//         console.log(response.data);
...
//   };
  const Edit = () => {
    ...
    axios
      .put("http://localhost:5066/api/Announcement/EditNotificcation/", notification)
      .then((response) => {
        console.log(response.data);
      })
      .catch((error) => console.log(error));
  ...
  const Delete = (e) => {
    e.preventDefault();
    axios
      .delete("http://localhost:5066/api/Announcement/DeleteNotification/" + id)
      .then((response) => {
        console.log(response.data);
      })
      .catch((error) => console.log(error));
        ...
        <table className="table table striped" >
          ...
          <tbody >
            ...
            <label htmlFor="message">Select Recipients</label>
              <td>
              <label className="container1">Teachers </label>
