...
const AddAttendanceStudent = () => {
  ...
  const fetchStudents = async () => {
    try {
      const response = await axios.get(`http://localhost:5066/api/Student/GetStudentBySection/${selectedStandard}/${selectedSection}`);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      for (const { studentId, isStudentPresent } of attendance) {
        await axios.post('http://localhost:5066/AddStudAttendence', { studentId, isStudentPresent }, {
...
<option value="CL01">C001</option>
<option value="CL02">C002</option>
<option value="CL03">C003</option>
<option value="CL04">C004</option>
<option value="CL05">C005</option>
<option value="CL06">C006</option>
