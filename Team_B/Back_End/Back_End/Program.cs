...
namespace NexEd_Project
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //builder.Services.AddTransient<TranscriptRepository>();
            builder.Services.AddTransient<IClassRepository, ClassRepository>();
            builder.Services.AddTransient<StudentAttendanceRepository>();
            builder.Services.AddTransient<TeacherAttendanceRepository>();
            builder.Services.AddTransient<UserRepository>();
            builder.Services.AddTransient<AssignRepository>();
